...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 190, 410, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 310, 90, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 510, 450, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png',510,610,30,30,1),
    new Obstaculo('imagenes/valla_vertical.png',860,400,30,30,1),
    new Obstaculo('imagenes/valla_vertical.png',840,420,30,30,1),
    new Obstaculo('imagenes/bache.png', 250,400,30,30,1),
    new Obstaculo('imagenes/bache.png', 130,280,30,30,1),
    new Obstaculo('imagenes/bache.png', 700,120,30,30,1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 770,455,30,15,1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 825,159,15,30,1),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 390, 155, 10, 10, 1, {
        ...
        new ZombieCaminante('imagenes/zombie2.png', 380, 150, 10, 10, 1, {
          desdeX: 0,
          hastaX: 741,
          desdeY: 0,
          hastaY: 807
        }),
        new ZombieCaminante('imagenes/zombie3.png', 455, 110, 10, 10, 1, {
          desdeX: 0,
          hastaX: 971,
          desdeY: 0,
          hastaY: 677
        }),
        new ZombieCaminante('imagenes/zombie4.png', 100, 455, 10, 10, 2, {
          desdeX: 0,
          hastaX: 961,
          desdeY: 0,
          hastaY: 577
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarImagen('imagenes/meta.png', 760, 500, 126, 30);
